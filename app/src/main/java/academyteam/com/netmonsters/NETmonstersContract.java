...
public final class NETmonstersContract {
    public static final String CREATE_MONSTER_TABLE = "CREATE TABLE " + FeedMonsters.TABLE_NAME + " (" + FeedMonsters.COULMN_NAME_MONSTERID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + FeedMonsters.COULMN_NAME_MONSTER + " TEXT, " + FeedMonsters.COULMN_NAME_BODYELEMENT  + " TEXT, " + FeedMonsters.COULMN_NAME_ATTACKELEMENT + " TEXT, " + FeedMonsters.COULMN_NAME_DOB + " BIGINT, " + FeedMonsters.COULMN_NAME_POWER + " INTEGER, " + FeedMonsters.COULMN_NAME_MAXHEALTH + " INTEGER, " + FeedMonsters.COULMN_NAME_CURRENTHEALTH + " INTEGER, " + FeedMonsters.COULMN_NAME_SPEED + " INTEGER, " + FeedMonsters.COULMN_NAME_INTELIGENCE + " INTEGER, " + FeedMonsters.COULMN_NAME_EXPERIENCE + " INTEGER, " + FeedMonsters.COULMN_NAME_LEVEL + " INTEGER, " + FeedMonsters.COULMN_NAME_EVOLVELEVEL + " TEXT " + FeedMonsters.COULMN_NAME_RARITY + " INTEGER, " + FeedMonsters.COULMN_NAME_OBEDIENCE + " INTEGER, " + FeedMonsters.COULMN_NAME_MORALITY + " INTEGER, " + FeedMonsters.COULMN_NAME_WINRATIO + " INTEGER " + FeedMonsters.COULMN_NAME_OWNED + " BOOLEAN " + FeedMonsters.COULMN_NAME_IMAGAGEFRONT + " TEXT " + FeedMonsters.COULMN_NAME_IMAGEBACK + " TEXT )";
    public static final String CREATE_ATTACK_TABLE = "CREATE TABLE " + FeedAttacks.TABLE_NAME + " (" + FeedAttacks.COULMN_NAME_ATTACKID +  " INTEGER PRIMARY KEY AUTOINCREMENT, " + FeedAttacks.COULMN_NAME_ATTACKNAME + " TEXT, "  + FeedAttacks.COULMN_NAME_TYPE + " TEXT " + FeedAttacks.COULMN_NAME_MAXDAMAGE + " INTEGER " + FeedAttacks.COULMN_NAME_MINDAMAGE + " INTEGER " + FeedAttacks.COULMN_NAME_HITS + " INTEGER " + FeedAttacks.COULMN_NAME_EFFECT + "TEXT )";
    public static final String CREATE_GRAVEYARD_TABLE = "CREATE TABLE " + FeedGraveyard.TABLE_NAME + " (" + FeedGraveyard.COULMN_NAME_GRAVESTONEID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + FeedGraveyard.COULMN_NAME_MONSTERNAME + " TEXT " + FeedGraveyard.COULMN_NAME_BODYELEMENT + " TEXT " + FeedGraveyard.COULMN_NAME_ATTACKELEMENT + " TEXT " + FeedGraveyard.COULMN_NAME_DOB + " BIGINT " + FeedGraveyard.COULMN_NAME_DOD + " BIGINT " + FeedGraveyard.COULMN_NAME_LEVEL + " INTEGER " + FeedGraveyard.COULMN_NAME_MORALITY + " INTEGER " + FeedGraveyard.COULMN_NAME_RARITY + " INTEGER " + FeedGraveyard.COULMN_NAME_WINRATIO + " INTEGER )";
