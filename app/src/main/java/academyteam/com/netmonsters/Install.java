...
public class Install {
    ...
    public Monster[] findMyMonsters() {
        ...
        cursor.moveToFirst();
        Monster monster1 = new Monster(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3),  cursor.getInt(4), cursor.getString(5), cursor.getString(6), cursor.getFloat(7),cursor.getFloat(8), cursor.getLong(9), cursor.getFloat(10), cursor.getFloat(11),cursor.getFloat(12), cursor.getFloat(13), cursor.getFloat(14), cursor.getFloat(15), cursor.getInt(16), cursor.getFloat(17));
        cursor.moveToNext();
        Monster monster2 = new Monster(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3),  cursor.getInt(4), cursor.getString(5), cursor.getString(6), cursor.getFloat(7),cursor.getFloat(8), cursor.getLong(9), cursor.getFloat(10), cursor.getFloat(11),cursor.getFloat(12), cursor.getFloat(13), cursor.getFloat(14), cursor.getFloat(15), cursor.getInt(16), cursor.getFloat(17));
        cursor.moveToNext();
        Monster monster3 = new Monster(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3),  cursor.getInt(4), cursor.getString(5), cursor.getString(6), cursor.getFloat(7),cursor.getFloat(8), cursor.getLong(9), cursor.getFloat(10), cursor.getFloat(11),cursor.getFloat(12), cursor.getFloat(13), cursor.getFloat(14), cursor.getFloat(15), cursor.getInt(16), cursor.getFloat(17));
